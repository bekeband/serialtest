...
${OBJECTDIR}/_ext/426300299/serialstream.o: ../SerialTest/serialstream.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/426300299
	${RM} $@.d
	$(COMPILE.cc) -O2 -DWINDOWS -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/426300299/serialstream.o ../SerialTest/serialstream.cpp
...
${OBJECTDIR}/MyString.o: MyString.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -DWINDOWS -MMD -MP -MF $@.d -o ${OBJECTDIR}/MyString.o MyString.cpp

${OBJECTDIR}/cmd.o: cmd.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -DWINDOWS -MMD -MP -MF $@.d -o ${OBJECTDIR}/cmd.o cmd.cpp
